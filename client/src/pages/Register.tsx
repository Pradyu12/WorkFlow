    ...
    <div style={{ minHeight: "100%", display: "flex", flexDirection: "column", background: ios.bg }}>
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 24px", maxWidth: 400, margin: "0 auto", width: "100%" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <div style={{ fontSize: 15, color: ios.textSecondary }}>Create your account</div>
        </div>
        ...
        <div style={{ textAlign: "center", marginTop: 24 }}>
          <span style={{ fontSize: 15, color: ios.textSecondary }}>Already have an account? </span>
          <Link to="/login" style={{ fontSize: 15, fontWeight: 500, color: ios.blue }}>Sign In</Link>
        </div>
      </div>
    </div>
  );
